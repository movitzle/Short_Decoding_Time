function [T_th] = main(D, N, width, loc, lambda1, c, L, b, T_vec, mu, s_FI, s_fixed, n_starting_points)
...
% Hard coded vectors to save results.
    ...
    for i=1:length(c)
        ...
        save(strcat('workspace_D_', num2str(D), '_b_', num2str(b),'_xi_',num2str(xi(1)),'_L_',num2str(L)))
