function [predictions] = getLowerBound(amps,width,N,L,D,c,lambda0)
    % see Equation S.35 in Supp. Mat. Note that this can be skipped (only changing the fitted regressor).
